...
const GettingStarted = () => {
  ...
  return (
    <div className='flex flex-col text-lg'>
      <h3 className='mt-4 text-4xl'>Getting Started</h3>

      <h4 className='mt-8 text-2xl'>This step-by-step tutorial will help you get started with Weelytical, an web traffic analytical tool to help you understand your custumers.</h4>
      ...
      <h3 className='mt-8 text-3xl'>Before you start</h3>

      <p className='mt-6'>To get started, create an account with Weelytical. You can select the plan that´s right for you.</p>

      <div className='flex flex-row gap-10 mt-4 px-20'>
        <Link href="register/signup" className='flex flex-col gap-2 flex-1 hover:bg-opacity-75 bg-opacity-80 rounded-xl py-6 px-10 bg-purple900 text-n100 border border-purple-900'>
        ...
        <Link href="sigin" className='flex flex-col gap-2 flex-1 hover:bg-opacity-75 bg-opacity-80 rounded-xl py-6 px-10 bg-purple900 text-n100 border border-purple-900'>
      ...
      <h3 className='mt-8 text-3xl'>Now that you have your account set up, pick a framework.</h3>
